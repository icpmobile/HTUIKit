...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView isEqual:_firstTableView]) {
        ...
        cell.textLabel.textColor = [UIColor  colorWithRed:68/255.0 green:68/255.0 blue:68/255.0 alpha:1.0];//ColorWihtRGBA(68, 68, 68);

        UIView *selectView = [[UIView alloc] initWithFrame:cell.contentView.bounds];
        selectView.backgroundColor = [UIColor  colorWithRed:243/255.0 green:243/255.0 blue:243/255.0 alpha:1.0];//ColorWihtRGBA(243, 243, 243);
        cell.selectedBackgroundView = selectView;
        cell.backgroundColor = [UIColor  colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1.0];//ColorWihtRGBA(235, 235, 235);
        ...
        //ColorWihtRGBA(68, 68, 68);
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        
        if (secondSelectedIndex == indexPath.row && firstSelectedIndex == clickIndex) {
            cell.accessoryType = UITableViewCellAccessoryCheckmark;
            cell.tintColor = [UIColor  colorWithRed:0/255.0 green:117/255.0 blue:207/255.0 alpha:1.0];//[UIColor redColor];
        } else {
...
- (void)p_layoutLeft:(NSInteger)cellRowCount {
    ...
    handleBottomLine.frame = CGRectMake(0, CGRectGetHeight(_handleView.frame)-1, [UIScreen mainScreen].bounds.size.width, 1);
...
- (void)p_returnSelectedValue:(NSInteger)index {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectedFirstValues:withTitle:)]) {
       ...
       // NSString *indexObj = [NSString stringWithFormat:@"%ld", (long)index];
        NSArray *values = @[@(firstSelected),@(index),@(m_selectedIndex)];
...
- (UITableView *)firstTableView {
    ...
    if (!_firstTableView) {
        ...
        _firstTableView.backgroundColor = [UIColor  colorWithRed:243/255.0 green:243/255.0 blue:243/255.0 alpha:1.0];//ColorWihtRGBA(243, 243, 243);
...
- (UIView *)handleView {
    ...
    if (!_handleView) {
        ...
        _handleView.layer.shadowColor = [UIColor  colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1.0].CGColor;//ColorWihtRGBA(235, 235, 235).CGColor;
        ...
        bottomLine.backgroundColor = [UIColor  colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1.0];
