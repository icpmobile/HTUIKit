...
- (void)layoutSubviews {
    ...
    CGSize titleSize = [self.titleLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"Helvetica" size:14]}];
...
- (UILabel *)titleLabel {
    ...
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor  colorWithRed:68/255.0 green:68/255.0 blue:68/255.0 alpha:1.0];//ColorWihtRGBA(68, 68, 68);
    }
    return _titleLabel;
}
